...
<body>
  <nav style="text-align: center; margin-top: 0px;">
    <img src="images/header2.png" style="width: 400px;">
  </nav>

  <center>

    <p style="font-size: 10px; text-align: justify; margin-left: 10px;">
      Certifico que o (a) funcionário(a): ______________________________________________________________________________________,<br>
      com número de registro: ______________________________, lotado(a) na UME: ____________________________________________,<br> 
