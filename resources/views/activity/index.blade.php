...
<div class="center1">
  ...
  <br>
  <form method="POST" action="search_activity">
    <div class="form-row">
          <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
          <input class="form-control col-md-10" type="text" id="search_key" name="search_key" placeholder="Pesquise por Atividades..." title="Type in a name" style="border-radius: 5px 0px 0px 5px;">
